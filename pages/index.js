      ...
      <div className="w-full h-full bg-gradient-to-r from-primary/10 via-black/30 to-black/10">
        <div className="text-center flex flex-col justify-center xl:pt-40 xl:text-left h-full container mx-auto">
          ...
          <motion.h1
            ...
            className="h1"
          >
            I'm Maulana Jafar Shodiq <br /> and{" "}
          ...
          >
            Saya adalah seorang desainer web dengan pengalaman luas selama lebih
            dari 5 tahun. Keahlian saya adalah menciptakan desain situs web,
            desain grafis, dan banyak lagi...
          </motion.p>
          {/* btn */}
